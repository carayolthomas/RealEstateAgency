...
<div class="main">
  ...
  <section id="content">
    <div class="container_12">
      <div class="grid_8"> 
		<?php
			unset($_SESSION['coAdm']);
			unset($_SESSION['$visites']);
			unset($_SESSION['nbVisites']);				
			unset($_SESSION['$visitesX']);
			unset($_SESSION['nbVisitesX']);
			unset($_SESSION['username']) ;
			unset($_SESSION['idcli']) ;
			session_destroy();
			echo "<center>Déconnexion réussie !!";
		?>
		<script type="text/javascript">
							<!--
							var obj = 'window.location.replace("http://localhost/realestate/index.php");';
							setTimeout(obj,0000);
							-->
		</script>
      </div>
